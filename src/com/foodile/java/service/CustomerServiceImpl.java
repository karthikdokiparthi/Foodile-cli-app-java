...
public class CustomerServiceImpl implements CustomerService{
    ...
    public Customers save(Customers customers) throws CustomerExitsException {
        ...
        if(customerById.isPresent()) throw new CustomerExitsException("Customer already Exists with this id : "+ customers.getId()+"\n"+"Customer already Exists with this Email: "+customers.getEmail());
